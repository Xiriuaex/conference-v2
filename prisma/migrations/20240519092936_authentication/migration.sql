/*
  ...
  - You are about to drop the `_MemberToRoom` table. If the table is not empty, all the data it contains will be lost.
...
-- DropForeignKey
ALTER TABLE `_MemberToRoom` DROP FOREIGN KEY `_MemberToRoom_A_fkey`;

-- DropForeignKey
ALTER TABLE `_MemberToRoom` DROP FOREIGN KEY `_MemberToRoom_B_fkey`;
